...
urlpatterns = [
    ...
    path("forgot-password/success/", views.forgot_password_success_view, name="forgot_password_success"),
    ...
    path("api/platform-branding/", views.api_platform_branding, name="api_platform_branding"),
    path("db-media/<path:file_key>/", views.db_media_file_view, name="db_media_file"),
    ...
    path(
        "admin-dashboard/delete-data/",
        views.deleted_data_view,
        {"category": "company"},
        name="deleted_data",
    ),
    path(
        "admin-dashboard/delete-data/<str:category>/",
        views.deleted_data_view,
        name="deleted_data_category",
    ),
    path(
        "admin-dashboard/delete-data/view/<int:log_id>/",
        views.deleted_data_detail_view,
        name="deleted_data_detail",
    ),
    path(
        "admin-dashboard/delete-data/delete/<int:log_id>/",
        views.deleted_data_delete_record_view,
        name="deleted_data_delete_record",
    ),
